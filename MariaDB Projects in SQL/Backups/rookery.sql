-- MySQL dump 10.15  Distrib 10.0.19-MariaDB, for Win64 (AMD64)
--
...
CREATE TABLE `birds_bill_shapes` (
  `bill_id` varchar(2) DEFAULT NULL,
  `bill_shape` varchar(25) DEFAULT NULL,
  `bill_example` blob,
...
CREATE TABLE `birds_body_shapes` (
  `body_id` varchar(3) DEFAULT NULL,
  `body_shape` varchar(25) DEFAULT NULL,
  `body_example` blob,
...
CREATE TABLE `birds_wing_shapes` (
  `wing_id` varchar(2) DEFAULT NULL,
  `wing_shape` varchar(25) DEFAULT NULL,
  `wing_example` blob,
...
-- Dump completed on 2015-07-27 21:53:27
